...
int main(){
  ...
  while(1){
    ...
    mew2Av += (mew2-t);
    mew3Av += (mew3-t);
    mew1Std = stdDeviation(mew1V, mew1Av/countL);
    mew2Std = stdDeviation(mew2V, mew2Av/countL);
    mew3Std = stdDeviation(mew3V, mew3Av/countL);
    ...
    // Print Stats
    printDetails(s, mew1Av, mew2Av, mew3Av, countL, mew1Max, mew2Max, mew3Max, q1a, q1p, q2p, q3p, mew1Std, mew2Std, mew3Std, drop, t, firstQ, Q1, itQ1, secondQ, Q2, itQ2, thirdQ, Q3, itQ3);
    wait(2);
  }
  return 0;
}
